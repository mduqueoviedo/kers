...
| ID and title | Status | Objective and user value | Concepts and scope | Acceptance and testing | Dependencies, priority, and notes |
| --- | --- | --- | --- | --- | --- |
| KAI-001 — Add the Kaiju model | In review | Persist known kaijus with valid categories and threat levels. | PHP enum, migration, Eloquent model, casts, constraints. | Fields and enum cast work; threat level is constrained to 1–5; migration rollback and database behavior are tested. | FND-004; High; this pull request. |
