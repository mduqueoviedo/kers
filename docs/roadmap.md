...
| KAI-002 — Add kaiju factory data | In review | Provide representative records for development and tests. | Factory states and a focused seeder. | Factory produces valid categories and threat levels; seeding is repeatable and tested where meaningful. | KAI-001; Medium; this pull request. |
