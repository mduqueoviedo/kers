...
| KAI-007 — Search and filter kaijus | Planned | Find kaijus by name, category, and threat level. | Query building and Livewire query-string synchronization. | Search and filters combine correctly, reset predictably, and retain pagination validity; Livewire tests cover combinations. | KAI-004A; Medium. |
