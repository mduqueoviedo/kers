...
API are complete. INC-006 and INC-007 are merged. INC-008 is the final Incident
item, followed by the English and Spanish localization checkpoint before
starting response teams.
